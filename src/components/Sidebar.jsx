...
import { Home, Book, FileText, FileSearch, UserCheck, Activity, MessageSquare, Users, Briefcase, Building, User, Settings, HelpCircle, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <div className={`flex flex-col h-[890px] bg-white transition-all duration-300 overflow-y-auto ${isCollapsed ? "w-16" : "w-56"}`}>
      ...
      <div className="p-4">
        <a href="#" className="flex items-center text-gray-700 hover:bg-gray-200 px-4 py-2">
