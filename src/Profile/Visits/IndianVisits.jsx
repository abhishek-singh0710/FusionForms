...
//   }, [])
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-[4910px] border-l-8 border-customSaveButtonColor">
      <h1 className="text-lg font-medium text-gray-800 mb-1">Add an Indian University Visit</h1>
      <hr />
      ...
      <div className="overflow-x-auto max-h-[400px]">
        {foreignVisits.length === 0 ? (
          <p className="text-gray-500">No Indian University Visits Recorded Yet</p>
        ) : (
