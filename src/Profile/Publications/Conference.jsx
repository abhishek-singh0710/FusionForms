    ...
    <div className="bg-white p-6 rounded-lg shadow-inner w-full max-w-[4910px] border-l-8 border-customSaveButtonColor">
      ...
      <form className="space-y-6 my-5" onSubmit={handleSubmit}>
        ...
        >
          ...
          />
          <span>Optional Conference Details</span>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInputs({ ...inputs, venueHostInstitute: e.target.value })
                }
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={inputs.dos}
                onChange={(e) =>
                  setInputs({ ...inputs, dos: e.target.value })
                }
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={inputs.doa}
                onChange={(e) =>
                  setInputs({ ...inputs, doa: e.target.value })
                }
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={inputs.dop}
                onChange={(e) =>
                  setInputs({ ...inputs, dop: e.target.value })
                }
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            ...
            <label
              ...
              <input
                ...
                onChange={(e) => setInputs({ ...inputs, conferenceDates: e.target.value })}
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="ISBN No"
                value={inputs.isbn}
                onChange={(e) => setInputs({ ...inputs, isbn: e.target.value })}
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              />
            </div>
          </div>
